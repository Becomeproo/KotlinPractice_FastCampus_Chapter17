...
import com.example.practicekotlin17.databinding.FragmentPlayerBinding
import com.example.practicekotlin17.service.MusicDto
import com.example.practicekotlin17.service.MusicService
...
class PlayerFragment : Fragment(R.layout.fragment_player) {
    ...
    private fun initPlayListButton(fragmentPlayerBinding: FragmentPlayerBinding) {
        fragmentPlayerBinding.playListImageView.setOnClickListener {
            Log.d("playListSize", model.currentPosition.toString())
